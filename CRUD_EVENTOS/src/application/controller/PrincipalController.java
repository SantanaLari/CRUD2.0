			...
			else 
			{
				try {
					if(cmd.contains("Listar")) {
						...
						//p.setEvento(Integer.parseInt(txtCodigoEvento_Programacao.getText()));
						p.setHorario(Integer.parseInt(txtHorarioProgramacao.getText()));
						p.setNome(txtNomeProgramacao.getText());
						
						if(!txtCodigoEvento_Programacao.getText().isEmpty()) {
							Evento ev = new Evento();
